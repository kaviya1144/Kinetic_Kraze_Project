...
import aboutUsImage1 from '../assets/images/2151046786.jpg';
import aboutUsImage2 from '../assets/images/18722294_v878-mind-64.jpg';
...
const CombinedPage = () => {
  ...
  return (
    ...
    <Navbar/>
    <Container>
      <Typography variant="h3" gutterBottom align="center" sx={{marginTop:'10px'}}>
        About Us
      </Typography>
