...
const CustomerForm = () => {
  ...
  async function saveDetails(event) {
    ...
    try {
      ...
      setId(newCustomerId);
      alert("Welcome to Kinetic Kraze, Happy fit journey");
    ...
    },
    {
      ...
      content: (
        ...
        >
          ...
          <Box>
            <img src={weightI} style={{ width: "10cm", height: "10cm" ,marginLeft:'2cm'}} />
          </Box>
        </div>
      ),
    },
    {
      ...
      content: (
        ...
        >
          ...
          <Box>
            <img src={frame} style={{ width: "10cm", height: "10cm" ,marginLeft:'2cm'}} />
          </Box>
        </div>
      ),
    },
    {
      ...
      content: (
        ...
        >
          ...
          <Box>
            <img src={Level} style={{ width: "10cm", height: "10cm" ,marginLeft:'2cm'}} />
          </Box>
        </div>
      ),
    },
    {
      ...
      content: (
        ...
        >
          ...
          <Box>
            <img src={day} style={{ width: "8cm", height: "8cm" ,marginLeft:'2cm'}} />
          </Box>
        </div>
      ),
    },
    {
      ...
      content: (
        ...
        >
          ...
          <Box>
            <img src={duration} style={{ width: "8cm", height: "8cm" ,marginLeft:'2cm'}} />
          </Box>
        </div>
      ),
    },
    {
      ...
      content: (
        ...
        >
          ...
          <Box>
            <img src={types} style={{ width: "10cm", height: "10cm",marginLeft:'2cm' }} />
          </Box>
        </div>
      ),
    },
    {
      ...
      content: (
        ...
        >
          ...
          <Box>
            <img src={equip} style={{ width: "8cm", height: "8cm" ,marginLeft:'2cm'}} />
          </Box>
        </div>
      ),
    },

    {
      title: (
        <Typography sx={{textAlign:'center', fontWeight: "bold",
          fontSize: "30px",marginLeft:'7cm'}}> Your Plan</Typography>
       )
        ,
      content: (
        <Container maxWidth="md" sx={{display:'flex',alignItems:'center',justifyContent:'center',marginLeft:'4cm'}}>
          <Box
            p={3}
            bgcolor="white"
            borderRadius={8}
  ...
  return (
    ...
    >
      <div>
        ...
        <Box sx={{marginBottom:'1rem',display:'flex',justifyContent:'center',alignItems:'center'}}>
          {currentStep > 0 && (
